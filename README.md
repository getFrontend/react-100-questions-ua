...
| 63  | [Що таке «code splitting» (розділення коду) в React?](#що-таке-code-splitting-розділення-коду-в-react)                                                                                       |
| 64  | [Як керувати станом між компонентами, що не мають близького зв'язку?](#як-керувати-станом-між-компонентами-що-не-мають-близького-зв'язку)                                                |
...
| 70  | [Яких принципів слід дотримуватися під час іменування компонентів у React?](#яких-принципів-слід-дотримуватися-під-час-іменування-компонентов-у-react)                                                     |
...
### Що таке «code splitting» (поділ коду) в React?
...
### Як керувати станом між компонентами, що не мають близького зв'язку?
...
### Яких принципів слід дотримуватися під час іменування компонентів у React?
